...
% ALT ALT Lab Due Date
% \item Lab 1 due by your lab session next Wed -- one submission per team sufficient
...
% ALT ALT
% \item OH today 3-3:30.

\item Next week.  No OH Tuesday. OH 3:30-5:30pm on Wednesday!

\item Prof. Cetinkaya-Rundel will be subbing for me on Tuesday.

\item PS 2 due Wednesday.
% ALT ALT
% \item PS 2 due Thursday.
...
- TAs associated with this class.

- Before Tuesdays' class make sure you review last video.

- Next problem set due next Thursday.

- Waitlist if class is at 120: drop earlier than later so others can add.
...
There are 80 observations make sure to take a note of that.

Sketch a box plot.  Be meticulous.

Can I turn that into a stem plot?
