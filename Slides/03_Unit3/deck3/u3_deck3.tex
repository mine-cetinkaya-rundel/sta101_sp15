...
% \item Office hours today: ask questions after class

% \item Midterm review: online, you should have received an email from WebEx with instructions

% \item Office hours tomorrow: online/on campus depending on weather
...
- Go back through end of last class.  Clicker question for $p$-value.  They will
likely get it wrong.  Go through each possibility on doc cam.

  - (b) tends to be a very common misconception---point that out.

  - Write (c), (d), and (e) as conditional probabilities.

  - What is the difference between (d) and (e).

  - How would we actually do this hypothesis test... go

  - Understanding p-values is one of the big learning objectives of this course.

- Go back through misconceptions about p-values.

- Use this to lead into decision errors.
...
- Going through 5 ideas today.

- Hypothesis tests and confidence intervals yield same result if same level
(when testing for a single mean).

- What if we are doing a one tailed test?
...
- I think it might make more sense to phrase in terms of the hypothesis test and
ask about the confidence level needed.
...
- Give about 30 seconds by this one.
...
- (c) and (d) still each have a decent share.
...
- All else held equal---same sample mean and same sample standard deviation.

- Example from videos.

- Effect size: weight loss program.
...
10 minutes.  Will probably need a little extra time.

- Slight addition to question 3:  In other words, if you wanted to produce a
confidence interval of the same width as that from question 2, but based on a
98\% confidence level, how many students would you need to sample?

- May need to help on Q3.
