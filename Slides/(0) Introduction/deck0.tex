...
\begin{frame}
\frametitle{Learning units}

{\footnotesize
\begin{itemize}[<+->]
\item \hl{Unit 1 - Introduction to data:} Observational studies and non-causal inference, principles of experimental design and causal inference, exploratory data analysis: description, summary and visualization, introduction to statistical inference.
\item \hl{Unit 2 - Probability and distributions:} The basics of probability and chance processes, Bayesian perspective in statistical inference, the normal distribution.
\item \hl{Unit 3 - Framework for inference:} Central Limit Theorem and sampling distributions
...
\item Application exercises, team readiness assessments, projects
...
\item Show all your work to receive credit, type your answers in the text box on Sakai (and attach any plots/images as separate files, properly named) or attach a PDF of your answers (no other file types will be accepted)

\item Welcomed and encouraged to work with others, but turn in your own work
\begin{itemize}
\item If you copy someone else's work, both parties will receive a 0 for the problem set grade as well as being reported to the Office of Student Conduct
\end{itemize}
...
\item Excused absences (e.g. STINF) do not excuse homework
...
\begin{frame}
\frametitle{Readiness assessments}

\red{Objective:} Encourage you to watch the videos and complete the reading assignment prior to coming to class and evaluate your conceptual understanding of the learning objectives.
...
\begin{frame}
\frametitle{Performance assessments}
...
\item Project 2: You will use all (relevant) techniques learned in this class to analyze a dataset provided by me. You will share your results in a poster session
...
\item While email is the quickest way to reach me outside of class, sometimes it may be more efficient to answer most statistical questions ``in person" so make use of OH

\item Any non-personal questions related to the material covered in class, problem sets, labs, projects, etc. should be posted on Piazza forum
...
\item If you can’t take the exams on these dates you should drop this class
...
\item Ask questions - during class or office hours, or by email. Ask me and your classmates.
...
\centering
\includegraphics[width=0.9\textwidth]{figures/babynames2013}
...
\webURL{http://www.babynamewizard.com/voyager}

\vfill

\includegraphics[width=0.9\textwidth]{figures/mine}
