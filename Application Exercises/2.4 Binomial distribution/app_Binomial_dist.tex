...
Gallup defines engaged employees as those who are involved in, enthusiastic about and committed to their work and workplace. Gallup categorizes workers as engaged based on their responses to key workplace elements it has found to predict important organizational performance outcomes. According to a recent Gallup poll, only 31.5\% of US employees were engaged in their jobs in 2014. Suppose that a company employs 1,000 people. Assume that the engagement rate stayed constant since 2014.
...
\item This company believes that ... Answer this question using two approaches:
\begin{enumerate}
