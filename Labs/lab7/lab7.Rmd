...
download("https://stat.duke.edu/courses/Fall14/sta101.001/labs/sta101_lab7.Rmd", destfile = "sta101_lab7.Rmd")
```
</div>
...
Note that the `inference` function you are introduced to in this lab will be very useful for your projects. More information on the function, as well as many functions used in Sta 101, can be found at https://stat.duke.edu/~mc301/R/Rcommands.pdf.
